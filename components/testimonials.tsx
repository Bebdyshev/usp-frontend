...
const testimonials = [
  {
    ...
    name: "MaKayla P.",
    company: "Disney",
    content: "CandyData has truly revolutionized our hiring process. The AI-driven candidate matching helps us find the right talent before even posting a job. It’s fast, efficient, and aligns perfectly with our brand values!",
    categories: [1, 3, 5],
  },
  {
    ...
    name: "Andrew K.",
    company: "Samsung",
    content: "After using CandyData, our candidate selection process has become remarkably streamlined. The quality of candidates presented is exceptional, and the AI negotiation feature saves us so much time!",
    categories: [1, 2, 4],
  },
  {
    ...
    name: "Lucy D.",
    company: "Rio",
    content: "With CandyData, recruitment is no longer a bottleneck for us. The insights and analytics have elevated our hiring strategy, allowing us to find the right candidates quickly and effectively.",
    categories: [1, 2, 5],
  },
  {
    ...
    name: "Pavel M.",
    company: "Canon",
    content: "The ease of use with CandyData is a breath of fresh air. Its intuitive interface and powerful AI tools have significantly enhanced our recruitment capabilities. It’s an invaluable part of our hiring toolkit.",
    categories: [1, 4],
  },
  {
    ...
    name: "Miriam E.",
    company: "Cadbury",
    content: "CandyData has exceeded our expectations. The AI tools help us identify top candidates quickly, and the comprehensive analytics dashboard makes tracking our hiring progress effortless. Highly recommended!",
    categories: [1, 3, 5],
  },
  {
    ...
    name: "Eloise V.",
    company: "Maffell",
    content: "I’m amazed at how effortlessly CandyData integrates into our hiring workflow. The quality of candidate output is outstanding, making it easy to focus on building a strong team.",
    categories: [1, 3],
  },
  {
    ...
    company: "Binance",
    content: "Finding the right talent has never been easier. CandyData's automated processes save us time and ensure we connect with candidates who truly fit our needs. It’s like having an extra set of hands!",
    categories: [1, 2, 5],
  },
  {
    ...
    name: "Danielle K.",
    company: "Forbes Inc.",
    content: "CandyData has transformed how we approach hiring. The tool’s efficiency and effectiveness have improved our overall strategy, allowing us to focus on hiring the best talent for our team.",
    categories: [1, 4],
  },
  {
    ...
    name: "Mary P.",
    company: "Ray Ban",
    content: "With CandyData, the recruitment process is smoother than ever. The AI-driven insights have elevated our hiring approach, ensuring we find the perfect candidates quickly and effectively!",
    categories: [1, 2],
  },
];
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            Solo entrepreneur, recruiter or large enterprise? We will find you the sweetest candidate!
          </p>
        </div>
